  ...
  return (
    <div>
      <div className="h-[300px] bg-[url('https://i.ibb.co.com/CKbFjmV/checkout.png')] bg-cover rounded-lg mb-20">
        <p className="px-12 pt-32 text-4xl font-medium text-white ">
          Service Details
        </p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row my-10">
        <div className="lg:w-4/5 p-4">
          <div>
            <img src={img} alt="" className="rounded-xl w-[800px]" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 mt-5 text-center gap-4 justify-items-center">
            <div className="card w-64 rounded-lg border-2 border-gray-100">
              <div className="card-body">
                <div>
                  {" "}
                  <img src={btn1} alt="" className="mx-auto" />
                </div>
            ...
            <div className="card w-64 rounded-lg border-2 border-gray-100">
              <div className="card-body">
                <div>
                  <img src={btn2} alt="" className="mx-auto" />
                </div>
            ...
            <div className="card w-64 rounded-lg border-2 border-gray-100">
              <div className="card-body">
                <div>
                  <img src={btn3} alt="" className="mx-auto" />
                </div>
          ...
          <div>
            <img src={imgV} alt="" className="my-8" />
          </div>
        </div>
        ...
        <div className="lg:w-1/3">
          ...
          <div className="bg-gray-200 p-4 rounded-xl m-6">
            ...
            <div className="space-y-6">
              <div className="bg-white flex justify-between items-center w-4/5 mx-auto p-2 rounded-md">
                ...
                <Link>
                  <a className="text-[#FF3811] text-3xl">➜</a>
                </Link>
              </div>
              <div className="bg-white flex justify-between items-center w-4/5 mx-auto p-2 rounded-md">
          ...
          <div className="bg-black text-white p-4 rounded-xl m-6">
            ...
            <div className="bg-white text-center rounded-md my-10 p-6 space-y-3 relative">
              ...
              <button className="bg-[#FF3811] rounded-md px-6 py-2 absolute right-20 md:right-96 lg:right-20">
                Get A Quote
              </button>
            </div>
          </div>
          {/* Quote end */}
          <p className="text-3xl font-bold mt-4 p-6 text-center lg:text-left">
            Price: ${price}
          </p>
          <div>
            <Link
              to={`/checkout/${_id}`}
              className="btn bg-[#FF3811] rounded-md px-24 py-2 text-white border-none flex mx-auto"
            >
              Proceed Checkout
            </Link>
          </div>
